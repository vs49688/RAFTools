...
public class AboutDialogCLS extends javax.swing.JDialog {

	public AboutDialogCLS(Frame parent) {
		super(parent, true);
		initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("and should not be considered stable for everyday use");
